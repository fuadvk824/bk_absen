...
export default function OvertimeReport({ offices }: Props) {
    ...
    const handleExport = () => {
        ...
        window.open(route('laporan.overtime.export', params), '_blank');
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                {
                    title: 'Export Rekap Lembur',
                    href: route('laporan.overtime.report'),
                },
            ]}
        >
            ...
            <div className="p-6">
                <div className=" space-y-6 rounded-xl border p-6">
                    <h1 className="text-xl font-semibold">Export Rekap Lembur</h1>
